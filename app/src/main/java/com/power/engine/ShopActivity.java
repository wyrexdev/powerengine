...
public class ShopActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear6.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				startActivity(new Intent(ShopActivity.this, MenuActivity.class)); Animatoo.animateShrink(ShopActivity.this);
			}
		});
		...
		linear8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				startActivity(new Intent(ShopActivity.this, InfoActivity.class)); Animatoo.animateShrink(ShopActivity.this);
			}
		});
		...
		linear10.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				startActivity(new Intent(ShopActivity.this, TutorialActivity.class)); Animatoo.animateShrink(ShopActivity.this);
			}
		});
		...
		gridview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				startActivity(new Intent(ShopActivity.this, ShopDetailActivity.class)); Animatoo.animateShrink(ShopActivity.this);
			}
		});
	}
	...
	private void initializeLogic() {
		...
		for(int _repeat45 = 0; _repeat45 < (int)(15); _repeat45++) {
			{
